...
void CPythonPlayer::__OnPressSmart(CInstanceBase& rkInstMain, bool isAuto, bool skipActor)
{
	...
	else if (isPickedActorID && dwPickedActorID != GetMainCharacterIndex() && !skipActor)
	{
...
void CPythonPlayer::__OnClickSmart(CInstanceBase& rkInstMain, bool isAuto, bool skipActor)
{
	DWORD dwPickedItemID;
	DWORD dwPickedActorID;
	TPixelPosition kPPosPickedGround;
	...
	else if (__GetPickedActorID(&dwPickedActorID) && !skipActor)
	{
