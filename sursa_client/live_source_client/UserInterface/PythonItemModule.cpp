...
PyObject* itemGetIconImageFileName2(PyObject* poSelf, PyObject* poArgs)
{
	char* szFileName;
	if (!PyTuple_GetString(poArgs, 0, &szFileName))
		return Py_BadArgument();
	...
	return Py_BuildValue("i", pItemData->GetIconImageFileName(szFileName));
}
#endif
#ifdef INGAME_WIKI
...
void initItem()
{
...
#endif
#ifdef ENABLE_EASTER_EVENT
		{ "GetIconImageFileName2",			itemGetIconImageFileName2,				METH_VARARGS },
#endif
	...
	PyModule_AddIntConstant(poModule, "MAX_SHOW_DURATION",		CItemData::MAX_SHOW_DURATION);
#endif
}
