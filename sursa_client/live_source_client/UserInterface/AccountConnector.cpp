...
bool CAccountConnector::__AuthState_RecvPhase()
{
	...
	else if (kPacketPhase.phase == PHASE_AUTH)
	{
		...
		strncpy(LoginPacket.game_version, "0.244", GAME_VERSION_MAX_LEN);
...
#endif
		LoginPacket.game_version[GAME_VERSION_MAX_LEN] = '\0';
		...
		LoginPacket.discordUserId = rkNetStream.GetDiscordUserId();
