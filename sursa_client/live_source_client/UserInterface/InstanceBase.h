...
class CInstanceBase
{
	...
	public:
		...
		enum
		{
			...
			AFFECT_ANTIEXP				 = 543,
#endif
			NEW_AFFECT_RESEARCHER_ELIXIR = 545,
	...
	public:
		...
		static bool IsItemHairColor(DWORD vnum);
#endif
	...
	protected:
		...
		DWORD					m_weaponShiningEffects[2][CItemData::ITEM_SHINE_MAX_NUM];
		DWORD					m_armorShiningEffects[CItemData::ITEM_SHINE_MAX_NUM];
