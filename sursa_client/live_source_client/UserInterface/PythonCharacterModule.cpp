...
PyObject* chrIsMobBoss(PyObject* poSelf, PyObject* poArgs)
{
	int iVirtualID;
	if (!PyTuple_GetInteger(poArgs, 0, &iVirtualID))
		return Py_BuildException();
	...
	return Py_BuildValue("i", pInstance->IsMobBoss());
}
...
void initchr()
{
	static PyMethodDef s_methods[] =
	{
		...
		{ "IsMobBoss",					chrIsMobBoss,						METH_VARARGS },
	...
	PyModule_AddIntConstant(poModule, "AFFECT_ANTIEXP",						CInstanceBase::AFFECT_ANTIEXP);
#endif

#ifdef ENABLE_PERMANENT_AFFECT
	PyModule_AddIntConstant(poModule, "AFFECT_CRITICALA", CInstanceBase::AFFECT_CRITICALA);
	PyModule_AddIntConstant(poModule, "AFFECT_PATRUNDERE", CInstanceBase::AFFECT_PATRUNDERE);
	PyModule_AddIntConstant(poModule, "AFFECT_ZEU_DRAGON1", CInstanceBase::AFFECT_ZEU_DRAGON1);
	PyModule_AddIntConstant(poModule, "AFFECT_ZEU_DRAGON2", CInstanceBase::AFFECT_ZEU_DRAGON2);
	PyModule_AddIntConstant(poModule, "AFFECT_ZEU_DRAGON3", CInstanceBase::AFFECT_ZEU_DRAGON3);
	PyModule_AddIntConstant(poModule, "AFFECT_ZEU_DRAGON4", CInstanceBase::AFFECT_ZEU_DRAGON4);
#endif
