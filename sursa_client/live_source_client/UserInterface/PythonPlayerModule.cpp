...
PyObject* playerGetHoursEventStage(PyObject* poSelf, PyObject* poArgs)
{
	return Py_BuildValue("i", CPythonPlayer::instance().GetHoursStage());
}
void initPlayer()
{
...
#endif
		{ "GetHoursEventStage", playerGetHoursEventStage, METH_VARARGS },
	...
	PyModule_AddIntConstant(poModule, "POINT_MALL_ATTBONUS",	POINT_ATT_BONUS);
	...
	PyModule_AddIntConstant(poModule, "SLOT_TYPE_POTIONS_INVENTORY", SLOT_TYPE_POTIONS_INVENTORY);
	...
	PyModule_AddIntConstant(poModule, "POTIONS_INVENTORY", POTIONS_INVENTORY);
	...
	PyModule_AddIntConstant(poModule, "HEXAGONAL_EVENT", HEXAGONAL_EVENT);

	PyModule_AddIntConstant(poModule, "EVENT_FISHING", EVENT_FISHING);
	PyModule_AddIntConstant(poModule, "EVENT_PVM", EVENT_PVM);
	PyModule_AddIntConstant(poModule, "EVENT_HIDE", EVENT_HIDE);
