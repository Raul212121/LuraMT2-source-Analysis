...
CGraphicSubImage* CItemData::GetIconImageFileName(const char* c_szFileName)
{
	return (CGraphicSubImage*)CResourceManager::Instance().GetResourcePointer(c_szFileName);
}
#endif
...
const char* CItemData::GetUseTypeString() const
{
	...
	switch (GetSubType())
	{
		...
		case USE_TIME_CHARGE_PER:
			return DEF_STR(USE_TIME_CHARGE_PER);
		case USE_TIME_CHARGE_FIX:
			return DEF_STR(USE_TIME_CHARGE_FIX);
#endif
	}
