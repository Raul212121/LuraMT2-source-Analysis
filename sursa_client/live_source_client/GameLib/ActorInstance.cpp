...
bool CActorInstance::IsShining()
{
	int ShiningList[] = { 34060, 34061, 34058, 34001, 34003, 20114, 20118, 34007, 34006, 34025, 34014};
	if (std::find(std::begin(ShiningList), std::end(ShiningList), m_eRace) != std::end(ShiningList))
		return true;
