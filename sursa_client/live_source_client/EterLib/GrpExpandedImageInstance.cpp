...
void CGraphicExpandedImageInstance::SetRenderingRectWithScale(float fLeft, float fTop, float fRight, float fBottom)
{
	...
	m_RenderingRectOld.left = fWidth * fLeft;
	m_RenderingRectOld.top = fHeight * fTop;
	m_RenderingRectOld.right = fWidth * fRight;
	m_RenderingRectOld.bottom = fHeight * fBottom;
}
#endif
