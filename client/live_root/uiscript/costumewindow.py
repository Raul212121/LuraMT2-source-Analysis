				...
				## Equipment Slot
				{
					...
					(

						{
							...
							"slot" : (
										{"index":COSTUME_START_INDEX+0, "x":62, "y":45, "width":32, "height":64},# costum
										{"index":COSTUME_START_INDEX+1, "x":62, "y": 9, "width":32, "height":32},# hair
										{"index":COSTUME_START_INDEX+2, "x":13, "y":126, "width":32, "height":32},# mount
										{"index":item.COSTUME_SLOT_PET, "x":62, "y":126, "width":32, "height":32}, # pet
										{"index":item.COSTUME_SLOT_WEAPON, "x":13, "y":13, "width":32, "height":96},#weapon
									),
						},
					),
				},
