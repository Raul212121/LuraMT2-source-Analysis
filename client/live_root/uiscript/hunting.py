	...
	(
		## BOARD
		{
			...
			(
				...
				{
					"name" : "close_button", "type" : "button", "x" : 0, "y" : 15 + 20, "horizontal_align" : "center", "vertical_align" : "bottom", "text" : "Close", "text_outline" : 1, "text_y" : -1,
					"default_image" : IMG_PATH + "button_small_normal.sub", "over_image" : IMG_PATH + "button_small_hover.sub", "down_image" : IMG_PATH + "button_small_down.sub", "disable_image" : IMG_PATH + "button_small_down.sub",
				},
				{
					"name" : "reward_button", "type" : "button", "x" : 15 + 120, "y" : 15 + 20, "vertical_align" : "bottom", "horizontal_align" : "right", "text" : "Colectea-za recompensa", "text_outline" : 1, "text_y" : -1,
					"default_image" : IMG_PATH + "button_small_normal.sub", "over_image" : IMG_PATH + "button_small_hover.sub", "down_image" : IMG_PATH + "button_small_down.sub", "disable_image" : IMG_PATH + "button_small_down.sub",
				},
			),
		},
