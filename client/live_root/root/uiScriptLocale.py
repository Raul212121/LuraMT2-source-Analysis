...
if "locale/ymir" == app.GetLocalePath():
	...
	JOBDESC_WARRIOR_PATH_OLD = "%s/jobdesc_warrior.txt" % (name)
	JOBDESC_ASSASSIN_PATH_OLD = "%s/jobdesc_assassin.txt" % (name)
	JOBDESC_SURA_PATH_OLD = "%s/jobdesc_sura.txt" % (name)
	JOBDESC_SHAMAN_PATH_OLD = "%s/jobdesc_shaman.txt" % (name)
