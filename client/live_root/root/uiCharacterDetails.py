import ui , localeInfo , player , item , uiToolTip , wndMgr , app
...
class CharacterDetailsUI(ui.ScriptWindow):
	...
	def __Initialize(self):
		...
		self.InfoList.append( [ localeInfo.DETAILS_22, localeInfo.DETAILS_TOOLTIP_22, item.GetApplyPoint( item.APPLY_RESIST_MONSTER ) ] )
		self.InfoList.append( [ localeInfo.DETAILS_23, localeInfo.DETAILS_TOOLTIP_23, item.GetApplyPoint( item.APPLY_RESIST_HUMAN ) ] )
	...
	def __ButtonOverIn(self, i):
		...
		self.toolTip.AutoAppendNewTextLine(tooltip, 0xffffff00)
		self.toolTip.Show()
