...
ACCOUNT_LOGIN_SECRET_KEY = "25442A472D4B6150645367566B59703373357638792F423F4528482B4D625165" # Don't touch me
...
## Enable/disable random selecting of channel
ENABLE_RANDOM_CHANNEL_SEL = 0
## Clean data if login fails
...
if app.ENABLE_EASTER_EVENT:
	EASTER_EVENT_STATUS = 0
	EGGS_VNUM = [
		24537, #Ou de Paste Mov
		24538, #Ou de Paste Rosu
		24539, #Ou de Paste Verde
		24540, #Ou de Paste Albastru
		24541, #Ou de Paste Bleu
	]

	def IsItemEgg(slotIndex):
		itemVnum = player.GetItemIndex(slotIndex)
		if itemVnum == 0:
			return False
		item.SelectItem(itemVnum)

		if itemVnum == EGGS_VNUM[0] or itemVnum == EGGS_VNUM[1] or itemVnum == EGGS_VNUM[2] or itemVnum == EGGS_VNUM[3] or itemVnum == EGGS_VNUM[4]:
			return True
...
# Pula mea
AUTHORIZED_LINKS = ["youtube.com", "twitch.tv", "mixer.com", "dlive.tv", "luramt2.ro"]
...
ENVIRONMENT_EVENING = "d:/ymir work/environment/mtthunder.msenv"
