...
class TargetBoard(ui.ThinBoard):
	...
	if app.ENABLE_TARGET_INFO_DROP:
		class InfoBoard(ui.ThinBoard):
			...
			SUB_RACE_FLAG_TO_NAME = {
				...
				1 << 17	: localeInfo.TARGET_INFO_RACE_METIN,
			}
			...
			def __LoadInformation_Drops(self, race):
				...
				if race in constInfo.MONSTER_INFO_DATA:
					if len(constInfo.MONSTER_INFO_DATA[race]["items"]) == 0:
						net.SendTargetInfoPacket(player.GetTargetVID())
	...
	if app.ENABLE_MESSENGER_BLOCK:
		BUTTON_NAME_LIST = BUTTON_NAME_LIST + (localeInfo.TARGET_BUTTON_BLOCK, localeInfo.TARGET_BUTTON_BLOCK_REMOVE, )
	...
	def __init__(self):
		...
		closeButton.SetUpVisual("d:/ymir work/ui/game/target/close_normal.tga")
		closeButton.SetOverVisual("d:/ymir work/ui/game/target/close_hover.tga")
		closeButton.SetDownVisual("d:/ymir work/ui/game/target/close_normal.tga")
		...
		if app.ENABLE_TARGET_INFO_DROP:
				...
				infoButton.SetUpVisual("d:/ymir work/ui/game/target/info_normal.tga")
				infoButton.SetOverVisual("d:/ymir work/ui/game/target/info_hover.tga")
				infoButton.SetDownVisual("d:/ymir work/ui/game/target/info_normal.tga")
	...
	def __ArrangeButtonPosition(self):
		...
		self.SetSize(max(224+60+50, showingButtonCount * 75), 65)
		self.UpdatePosition()
