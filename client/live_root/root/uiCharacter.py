...
class CharacterWindow(ui.ScriptWindow):
	...
	def __BindObject(self):
		...
		self.characterNameSlot.SAFE_SetEvent(self.__ShowAlignmentToolTip, "MOUSE_OVER_IN")
		self.characterNameSlot.SAFE_SetEvent(self.__HideAlignmentToolTip, "MOUSE_OVER_OUT")
	...
	if app.ENABLE_DETAILS_UI:
		...
		def __ClickExpandButton(self):
			...
			self.chDetailsWnd.Show()
			self.chDetailsWnd.AdjustPosition(x+250,y)
			self.ExpandBtn.Hide()
