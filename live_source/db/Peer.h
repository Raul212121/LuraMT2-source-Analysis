...
#pragma pack()
	...
	void SetAuth(bool isAuth) { m_bIsAuth = isAuth; }
	bool IsAuth() const { return m_bIsAuth; }

	void SetGuildMarkServer(bool value) { m_guild_mark_server = value; }
	bool IsGuildMarkServer() const { return m_guild_mark_server; }
