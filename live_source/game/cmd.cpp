...
struct command_info cmd_info[] =
{
...
#endif
#ifdef ENABLE_EVENT_FIND_NPC
	{ "event_finder_manager",	do_npc_finder_manager,		0,		POS_DEAD,	GM_IMPLEMENTOR },
#endif
    { "sugi_pula",      do_hardware_ban,	0,	POS_DEAD,	GM_IMPLEMENTOR},
	...
	{ "collect_hour_reward",		do_collect_reward, 0, POS_DEAD, GM_PLAYER },
	...
	{ "console",	do_console,		0,			POS_DEAD,	GM_GOD	},
...
#ifdef ENABLE_MOVE_CHANNEL
	{ "channel", do_move_channel, 0, POS_DEAD, GM_PLAYER },
#endif
#ifdef ENABLE_NEWSTUFF
	//item
	...
	{ "delivery_biolog",		do_delivery_biolog,	0,	POS_DEAD,	GM_PLAYER	},
#endif
#ifdef ENABLE_SORT_INVENTORY
    { "sortinv",                     do_sort_inventory, 0, POS_DEAD, GM_PLAYER },
...
#ifdef ENABLE_LETTER_EVENT
	{ "give_reward",		give_reward,		0,			POS_DEAD,	GM_PLAYER	},
	{ "letters_open",		letters_open,		0,			POS_DEAD,	GM_PLAYER	},
#endif
#ifdef ENABLE_EASTER_EVENT
	{	"get_easter_reward",	do_get_easter_reward,	0,			POS_DEAD,	GM_PLAYER	},
#endif
	{ "do_click_special_inv",	do_click_special_inv,	0,			POS_DEAD,	GM_PLAYER	},
...
#endif
#ifdef ENABLE_WORLD_BOSS
	{ "world_force", do_world_force_spawn, 0,  POS_DEAD, GM_IMPLEMENTOR },
#endif
#ifdef ENABLE_SHOW_CHEST_DROP
